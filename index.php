...
<?php if ($team_logged_in): ?>
            ...
            <div id="ajaxcontainer">
                <div id="ajaxdata" class="row" data-market-open="<?php echo $market_open; ?>" data-market-ended="<?php echo $market_ended; ?>" data-market-end-round-time="<?php echo $market_end_round_time; ?>">
                    <div class="span8">
                        <table id='teamorders'>
